...
public class DBManager : SingletonBehaviour<DBManager>
{
    ...
    // 스팀 클라우드에 저장할 파일명 (로컬 파일명과 일치시킴)
    private string steamSaveFileName => Path.GetFileName(saveFilePath); // "SaveData.json"
    ...
    public void SaveSteam()
    {
        ...
        try
        {
            string sd = JsonUtility.ToJson(saveData, true);
    ...
    public void LoadSteam()
    {
        ...
        catch (System.Exception e)
        {
            ...
            saveData = new SaveData(); // 문제 발생 시 새 데이터로 초기화
        }
    }
    ...
    public void LoadLocal()
    {
        ...
        if (!File.Exists(saveFilePath))
        {
            ...
            saveData = new SaveData(); // 새 SaveData 객체 생성
            return;
        }
...
public class CharacterData
{
    ...
    public List<GearData> gearDatas = new List<GearData>();
    public List<LanternData> lanternDatas = new List<LanternData>();
