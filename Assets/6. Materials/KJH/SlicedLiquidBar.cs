...
public class SlicedLiquidBar : MonoBehaviour, IMaterialModifier
{
    // --- 셰이더로 전달할 값 ---
    [Range(0f, 1f)][SerializeField] float _value = 0.5f;
    [SerializeField] AnimationCurve curve;
    public Vector2Int xPosRange = new Vector2Int(20, 750);
    // --- 셰이더 속성 ID 캐시 ---
    ...
    protected void Awake()
    {
        ...
        {
            //Debug.LogError("SlicedLiquidBar requires an Image component set to Sliced type.", this);
            enabled = false;
            return;
        }
